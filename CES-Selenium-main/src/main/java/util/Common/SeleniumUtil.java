...
public class SeleniumUtil {
	...
	public SeleniumUtil(WebDriver dr,ExtentTest ext, String BrowserName, String webUrl, int wait_Time) {
		...
		driver.get(webUrl);
		Log(BrowserName+" -- opening the URL -- "+webUrl);
	}
	...
	public void logE(String stringMessage) {
		Etest.pass(stringMessage);
	}
	...
	public void logList(List<WebElement> ListWebelement) {
		List<String> list = getList(ListWebelement);
		for(String li : list){
			Log(li);
		}
	}
	...
	public void logList(By by) {
		List<String> list = getList(by);
		for(String li : list){
			Log(li);
		}
	}
	
	public void logListString(List<String> ListString) {
		for(String li : ListString){
			Log(li);
		}
	}
	...
	public void logCListString(List<String> ListString) {
		for(String li : ListString){
			logC(li);
		}
	}
	...
	public void logEListString(List<String> ListString) {
		for(String li : ListString){
			logE(li);
		}
	}
	...
	public Boolean waitPageLoad() {
		...
		for (int i =1; i<=waitTime*1000 ; i++) {
			try {
				if(js.executeScript("return document.readyState").toString().contains("active") || js.executeScript("return document.readyState").toString().equals("complete") ) {
					flag = true;
					break;
				}else {
					sleepMilliSeconds(1);
	...
	public void pageScreenShot() {
		new ScreenShotUtil().ExtentPassShot(driver, Etest, testNAme);
	}

	public void elementScreenShot(WebElement ele) {
		new ScreenShotUtil().ExtentElementShot(ele, Etest, testNAme);
	}
	...
	public Boolean type(WebElement ele, String Value) {
		Boolean flag=  false;
	...
	public Boolean type(By by, String Value) {
		WebElement ele = getElement(by);
	...
	public Boolean jsType(WebElement ele, String Value) {
		JavascriptExecutor js = (JavascriptExecutor)driver;	
		Boolean flag=  false;
	...
	public Boolean jsType(By by, String Value) {
		WebElement ele = getElement(by);
	...
	public Boolean actionType(WebElement ele, String Value) {
		Actions actions = new Actions(driver);
		Boolean flag=  false;
	...
	public Boolean actionType(By by, String Value) {
		WebElement ele = getElement(by);
		return actionType(ele,Value);

	}

	public Boolean actionType(String Value) {
		Actions actions = new Actions(driver);
		Boolean flag=  false;
